...
def save_config(cfg: Config, config_path: Path | None = None) -> None:
    ...
    data = {
        "app": {"poll_interval_minutes": cfg.app.poll_interval_minutes, "host": cfg.app.host, "port": cfg.app.port, "default_model": cfg.app.default_model, "model_aliases": cfg.app.model_aliases},
        "paths": {
